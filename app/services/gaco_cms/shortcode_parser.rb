...
module GacoCms
  class ShortcodeParser < ApplicationService # rubocop:disable Metrics/ClassLength
    ...
    def shortcodes # rubocop:disable Metrics/MethodLength
      ...
      }.merge(GacoCms::Config.extra_shortcodes).except(*ignored_shortcodes)
    end
    ...
    def parse_shortcode(code, attrs, args = {})
      ...
      if renderer.is_a?(String)
        params = { attrs: attrs, args: args }
        ApplicationController.renderer.render template: renderer, layout: nil, assigns: params, formats: [:html]
      else
